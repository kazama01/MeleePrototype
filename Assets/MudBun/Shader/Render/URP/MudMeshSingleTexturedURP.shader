	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.ase_texcoord14.xyz = vertexToFrag27_g234;
						 ...
						 ) : SV_Target
			{
				...
				float3 vertexToFrag257 = IN.ase_texcoord11.xyz;
				...
				float3 vertexToFrag27_g234 = IN.ase_texcoord14.xyz;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 vertexToFrag247 = temp_output_198_2;
				o.ase_texcoord4.xyz = vertexToFrag247;
				float3 vertexToFrag246 = PositionLs4_g83;
				o.ase_texcoord5.xyz = vertexToFrag246;
				float4 vertexToFrag5_g83 = Color4_g83;
				o.ase_texcoord6 = vertexToFrag5_g83;
				
				float3 vertexToFrag6_g83 = (EmissionHash4_g83).xyz;
				o.ase_texcoord7.xyz = vertexToFrag6_g83;
				
				float3 vertexToFrag16_g83 = PositionWs4_g83;
				o.ase_texcoord8.xyz = vertexToFrag16_g83;
				float3 vertexToFrag27_g234 = temp_output_198_0;
				o.ase_texcoord9.xyz = vertexToFrag27_g234;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 appendResult238 = (float3(_MainTexX , _MainTexY , _MainTexZ));
				float3 vertexToFrag247 = IN.ase_texcoord4.xyz;
				float3 temp_output_44_0_g232 = ( appendResult238 * abs( vertexToFrag247 ) );
				float3 break14_g232 = temp_output_44_0_g232;
				float3 vertexToFrag246 = IN.ase_texcoord5.xyz;
				float3 temp_output_36_0_g232 = vertexToFrag246;
				float4 appendResult23_g232 = (float4(temp_output_44_0_g232 , 0.0));
				float4 appendResult24_g232 = (float4(temp_output_44_0_g232 , 1.0));
				float4 break10_g233 = ( ( break14_g232.x + break14_g232.y + break14_g232.z ) > 0.0 ? appendResult23_g232 : appendResult24_g232 );
				float4 color20_g232 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				float4 color182 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 vertexToFrag5_g83 = IN.ase_texcoord6;
				float4 temp_output_25_0_g83 = ( _IsMeshRenderMaterial * _Color * vertexToFrag5_g83 );
				float4 temp_output_175_0 = ( ( _UseTex0 > 0.0 ? ( ( ( ( break14_g232.x > 0.0 ? tex2D( _MainTex, ( ( (temp_output_36_0_g232).yz * _MainTex_ST.xy ) + _MainTex_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g233.x ) + ( ( break14_g232.y > 0.0 ? tex2D( _MainTex, ( ( (temp_output_36_0_g232).zx * _MainTex_ST.xy ) + _MainTex_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g233.y ) + ( ( break14_g232.z > 0.0 ? tex2D( _MainTex, ( ( (temp_output_36_0_g232).xy * _MainTex_ST.xy ) + _MainTex_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g233.z ) + ( color20_g232 * break10_g233.w ) ) / ( break10_g233.x + break10_g233.y + break10_g233.z + break10_g233.w ) ) : color182 ) * temp_output_25_0_g83 );
				
				float3 vertexToFrag6_g83 = IN.ase_texcoord7.xyz;
				
				float localComputeOpaqueTransparency20_g234 = ( 0.0 );
				float3 vertexToFrag16_g83 = IN.ase_texcoord8.xyz;
				float4 unityObjectToClipPos1_g84 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag16_g83));
				float4 computeScreenPos3_g84 = ComputeScreenPos( unityObjectToClipPos1_g84 );
				float2 ScreenPos20_g234 = (( ( computeScreenPos3_g84 / (computeScreenPos3_g84).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g234 = IN.ase_texcoord9.xyz;
				float3 VertPos20_g234 = vertexToFrag27_g234;
				float localMudBunMeshPoint4_g83 = ( 0.0 );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;259;2688,-228;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;260;2688,-228;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;1;LightMode=UniversalGBuffer;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;261;2688,-228;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;True;4;d3d11;glcore;gles;gles3;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;262;2688,-228;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;True;4;d3d11;glcore;gles;gles3;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=19ECCCDAE7BF894BDC377DCB10144677F85F47D5