...
Shader "MudBun/Mud Mesh Multi-Textured (URP)"
{
	Properties
	{
		...
		[Toggle]_Norm3Z("Project Normal Map 3 Z", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.ase_texcoord8.xyz = vertexToFrag213;
				float3 vertexToFrag212 = PositionLs4_g83;
				o.ase_texcoord9.xyz = vertexToFrag212;
				float4 vertexToFrag224 = TextureWeight4_g83;
				o.ase_texcoord10 = vertexToFrag224;
				float4 vertexToFrag5_g83 = Color4_g83;
				o.ase_texcoord11 = vertexToFrag5_g83;
				
				float3 vertexToFrag269 = TangentWs4_g83;
				o.ase_texcoord12.xyz = vertexToFrag269;
				
				float3 vertexToFrag6_g83 = (EmissionHash4_g83).xyz;
				o.ase_texcoord13.xyz = vertexToFrag6_g83;
				
				float vertexToFrag8_g83 = Metallic4_g83;
				o.ase_texcoord8.w = vertexToFrag8_g83;
				
				float vertexToFrag7_g83 = Smoothness4_g83;
				o.ase_texcoord9.w = vertexToFrag7_g83;
				
				float3 vertexToFrag16_g83 = PositionWs4_g83;
				o.ase_texcoord14.xyz = vertexToFrag16_g83;
				float3 vertexToFrag27_g246 = temp_output_198_0;
				o.ase_texcoord15.xyz = vertexToFrag27_g246;
				
				o.ase_texcoord12.w = v.ase_vertexID;
						 ...
						 ) : SV_Target
			{
				...
				float3 vertexToFrag213 = IN.ase_texcoord8.xyz;
				...
				float3 vertexToFrag212 = IN.ase_texcoord9.xyz;
				...
				float4 vertexToFrag224 = IN.ase_texcoord10;
				...
				float4 vertexToFrag5_g83 = IN.ase_texcoord11;
				...
				float3 vertexToFrag269 = IN.ase_texcoord12.xyz;
				...
				float3 vertexToFrag6_g83 = IN.ase_texcoord13.xyz;
				
				float vertexToFrag8_g83 = IN.ase_texcoord8.w;
				
				float vertexToFrag7_g83 = IN.ase_texcoord9.w;
				
				float localComputeOpaqueTransparency20_g246 = ( 0.0 );
				float3 vertexToFrag16_g83 = IN.ase_texcoord14.xyz;
				...
				float3 vertexToFrag27_g246 = IN.ase_texcoord15.xyz;
				float3 VertPos20_g246 = vertexToFrag27_g246;
				float localMudBunMeshPoint4_g83 = ( 0.0 );
				int VertexID4_g83 = IN.ase_texcoord12.w;
				float3 PositionWs4_g83 = float3( 0,0,0 );
				float3 PositionLs4_g83 = float3( 0,0,0 );
				float3 NormalWs4_g83 = float3( 0,0,0 );
				float3 NormalLs4_g83 = float3( 0,0,0 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 vertexToFrag213 = temp_output_198_2;
				o.ase_texcoord4.xyz = vertexToFrag213;
				float3 vertexToFrag212 = PositionLs4_g83;
				o.ase_texcoord5.xyz = vertexToFrag212;
				float4 vertexToFrag224 = TextureWeight4_g83;
				o.ase_texcoord6 = vertexToFrag224;
				float4 vertexToFrag5_g83 = Color4_g83;
				o.ase_texcoord7 = vertexToFrag5_g83;
				
				float3 vertexToFrag6_g83 = (EmissionHash4_g83).xyz;
				o.ase_texcoord8.xyz = vertexToFrag6_g83;
				
				float3 vertexToFrag16_g83 = PositionWs4_g83;
				o.ase_texcoord9.xyz = vertexToFrag16_g83;
				float3 vertexToFrag27_g246 = temp_output_198_0;
				o.ase_texcoord10.xyz = vertexToFrag27_g246;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 appendResult230 = (float3(_MainTexX , _MainTexY , _MainTexZ));
				float3 vertexToFrag213 = IN.ase_texcoord4.xyz;
				float3 temp_output_167_0_g236 = vertexToFrag213;
				float3 temp_output_44_0_g242 = ( appendResult230 * abs( temp_output_167_0_g236 ) );
				float3 break14_g242 = temp_output_44_0_g242;
				float3 vertexToFrag212 = IN.ase_texcoord5.xyz;
				float3 temp_output_166_0_g236 = vertexToFrag212;
				float3 temp_output_36_0_g242 = temp_output_166_0_g236;
				float4 appendResult23_g242 = (float4(temp_output_44_0_g242 , 0.0));
				float4 appendResult24_g242 = (float4(temp_output_44_0_g242 , 1.0));
				float4 break10_g243 = ( ( break14_g242.x + break14_g242.y + break14_g242.z ) > 0.0 ? appendResult23_g242 : appendResult24_g242 );
				float4 color20_g242 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				float4 vertexToFrag224 = IN.ase_texcoord6;
				float4 break10_g241 = vertexToFrag224;
				float3 appendResult232 = (float3(_Tex1X , _Tex1Y , _Tex1Z));
				float3 temp_output_44_0_g244 = ( appendResult232 * abs( temp_output_167_0_g236 ) );
				float3 break14_g244 = temp_output_44_0_g244;
				...
				float4 color20_g239 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				float4 color182 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 vertexToFrag5_g83 = IN.ase_texcoord7;
				float4 temp_output_25_0_g83 = ( _IsMeshRenderMaterial * _Color * vertexToFrag5_g83 );
				float4 temp_output_175_0 = ( ( ( _UseTex0 + _UseTex1 + _UseTex2 + _UseTex3 ) > 0.0 ? ( ( ( ( (float)(int)_UseTex0 > 0.0 ? ( ( ( ( break14_g242.x > 0.0 ? tex2D( _MainTex, ( ( (temp_output_36_0_g242).yz * _MainTex_ST.xy ) + _MainTex_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g243.x ) + ( ( break14_g242.y > 0.0 ? tex2D( _MainTex, ( ( (temp_output_36_0_g242).zx * _MainTex_ST.xy ) + _MainTex_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g243.y ) + ( ( break14_g242.z > 0.0 ? tex2D( _MainTex, ( ( (temp_output_36_0_g242).xy * _MainTex_ST.xy ) + _MainTex_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g243.z ) + ( color20_g242 * break10_g243.w ) ) / ( break10_g243.x + break10_g243.y + break10_g243.z + break10_g243.w ) ) : float4( 0,0,0,0 ) ) * break10_g241.x ) + ( ( (float)(int)_UseTex1 > 0.0 ? ( ( ( ( break14_g244.x > 0.0 ? tex2D( _Tex1, ( ( (temp_output_36_0_g244).yz * _Tex1_ST.xy ) + _Tex1_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g245.x ) + ( ( break14_g244.y > 0.0 ? tex2D( _Tex1, ( ( (temp_output_36_0_g244).zx * _Tex1_ST.xy ) + _Tex1_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g245.y ) + ( ( break14_g244.z > 0.0 ? tex2D( _Tex1, ( ( (temp_output_36_0_g244).xy * _Tex1_ST.xy ) + _Tex1_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g245.z ) + ( color20_g244 * break10_g245.w ) ) / ( break10_g245.x + break10_g245.y + break10_g245.z + break10_g245.w ) ) : float4( 0,0,0,0 ) ) * break10_g241.y ) + ( ( (float)(int)_UseTex2 > 0.0 ? ( ( ( ( break14_g237.x > 0.0 ? tex2D( _Tex2, ( ( (temp_output_36_0_g237).yz * _Tex2_ST.xy ) + _Tex2_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g238.x ) + ( ( break14_g237.y > 0.0 ? tex2D( _Tex2, ( ( (temp_output_36_0_g237).zx * _Tex2_ST.xy ) + _Tex2_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g238.y ) + ( ( break14_g237.z > 0.0 ? tex2D( _Tex2, ( ( (temp_output_36_0_g237).xy * _Tex2_ST.xy ) + _Tex2_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g238.z ) + ( color20_g237 * break10_g238.w ) ) / ( break10_g238.x + break10_g238.y + break10_g238.z + break10_g238.w ) ) : float4( 0,0,0,0 ) ) * break10_g241.z ) + ( ( (float)(int)_UseTex3 > 0.0 ? ( ( ( ( break14_g239.x > 0.0 ? tex2D( _Tex3, ( ( (temp_output_36_0_g239).yz * _Tex3_ST.xy ) + _Tex3_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g240.x ) + ( ( break14_g239.y > 0.0 ? tex2D( _Tex3, ( ( (temp_output_36_0_g239).zx * _Tex3_ST.xy ) + _Tex3_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g240.y ) + ( ( break14_g239.z > 0.0 ? tex2D( _Tex3, ( ( (temp_output_36_0_g239).xy * _Tex3_ST.xy ) + _Tex3_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g240.z ) + ( color20_g239 * break10_g240.w ) ) / ( break10_g240.x + break10_g240.y + break10_g240.z + break10_g240.w ) ) : float4( 0,0,0,0 ) ) * break10_g241.w ) ) / ( break10_g241.x + break10_g241.y + break10_g241.z + break10_g241.w ) ) : color182 ) * temp_output_25_0_g83 );
				
				float3 vertexToFrag6_g83 = IN.ase_texcoord8.xyz;
				
				float localComputeOpaqueTransparency20_g246 = ( 0.0 );
				float3 vertexToFrag16_g83 = IN.ase_texcoord9.xyz;
				float4 unityObjectToClipPos1_g84 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag16_g83));
				float4 computeScreenPos3_g84 = ComputeScreenPos( unityObjectToClipPos1_g84 );
				float2 ScreenPos20_g246 = (( ( computeScreenPos3_g84 / (computeScreenPos3_g84).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g246 = IN.ase_texcoord10.xyz;
				float3 VertPos20_g246 = vertexToFrag27_g246;
				float localMudBunMeshPoint4_g83 = ( 0.0 );
				int VertexID4_g83 = IN.ase_texcoord4.w;
				float3 PositionWs4_g83 = float3( 0,0,0 );
				float3 PositionLs4_g83 = float3( 0,0,0 );
				float3 NormalWs4_g83 = float3( 0,0,0 );
				float3 NormalLs4_g83 = float3( 0,0,0 );
...
Node;AmplifyShaderEditor.TexturePropertyNode;158;128,-1808;Inherit;True;Property;_Tex1;Texture 1;22;0;Create;False;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;223;2944,-960;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Universal2D;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;218;2816,-288;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;221;2944,-960;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;219;2816,-288;Float;False;True;-1;2;MudBun.MudMeshMultiTexturedMaterialEditor;0;12;MudBun/Mud Mesh Multi-Textured (URP);94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;4;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;40;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;220;2944,-960;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;222;2944,-960;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;270;2816,-228;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;271;2816,-228;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;1;LightMode=UniversalGBuffer;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;272;2816,-228;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;True;4;d3d11;glcore;gles;gles3;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;273;2816,-228;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;True;4;d3d11;glcore;gles;gles3;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=B6FA1EC34AF4635B95D8C64975EF7F5D86D8330C