...
namespace GameCreator.Runtime.VisualScripting
{
    ...
    [Category("Renderer/Material Modifier")]
    ...
    [Serializable]
    public class InstructionMatsModifier : TInstructionRenderer
    {
        // MEMBERS: -------------------------------------------------------------------------------
        [SerializeField]
        ...
        protected override async Task Run(Args args)
        {
            ...
            float valueSource = material.GetFloat(propertyID);
            ...
            ITweenInput tween = new TweenInput<float>(
                ...
                (a, b, t) => material.SetFloat(propertyID, Mathf.Lerp(a, b, t)),
