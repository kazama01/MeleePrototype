    ...
    public class ProjectileShooter : MonoBehaviour
    {
        ...
        void ShootProjectile()
        {
            ...
            if (Physics.Raycast(ray, out hit, 300, layerMask.value))
            {
                ...
                GameObject projectile = Instantiate(projectilePrefab, shootPoint.position, Quaternion.identity, transform);

                dissolve.AddMask(projectile.GetComponent<Mask>());
